...
Deform::Deform(float *P_data, int P_Num, AdjList &adj_list, FaceList &face_list)
...
float *Deform::do_Deform(VectorF &T, VectorI &idx_T)
{
    int iter = 0;
    double delta = 0;
...
float Deform::compute_wij(float *p1, float *p2, float *p3, float *p4)
{
