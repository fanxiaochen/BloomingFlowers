...
WeightedModel::WeightedModel(PointCloud* point_cloud, Flower* flower)
    :petal_num_(0),
    iter_num_(30), 
    eps_(1e-3),
    lambda_(0.05),
...
void WeightedModel::setIterNum(int iter_num)
{
    iter_num_ = iter_num;
}

void WeightedModel::setEps(double eps)
{
    eps_ = eps;
}

void WeightedModel::setPointCloud(PointCloud* point_cloud)
{
    point_cloud_ = point_cloud;
}

void WeightedModel::setFlower(Flower* flower)
{
    flower_ = flower;
}

void WeightedModel::deform()
{
    //// visibility
    //visibility();
    // initial step
...
void WeightedModel::e_step(int petal_id)
{
...
void WeightedModel::visibility()
{
    flower_->determineVisibility();
}


void WeightedModel::initialize()
{
...
double WeightedModel::gaussian(int petal_id, int m_id, int c_id)
{
    double p;
...
void WeightedModel::buildWeightMatrix(int petal_id)
{
...
void WeightedModel::updateLeftSys()
{
    L_.clear();
    L_.resize(3); // x, y, z
...
void WeightedModel::updateLeftSys(int petal_id)
{
    DeformPetal& deform_petal = deform_petals_[petal_id];
...
void WeightedModel::updateRightSys(int petal_id)
{
    DeformPetal& deform_petal = deform_petals_[petal_id];
...
void WeightedModel::updateRightSys()
{
    d_.resize(3, 0);
...
void WeightedModel::updateRotation(int petal_id)
{
    DeformPetal& deform_petal = deform_petals_[petal_id];
    PetalMatrix& origin_petal = deform_petal._origin_petal;
...
void WeightedModel::updateRotation()
{
    for (size_t i = 0; i < petal_num_; ++ i)
    {
        updateRotation(i);
...
void WeightedModel::initRotation()
{
...
double WeightedModel::zero_correction(double value)
{
