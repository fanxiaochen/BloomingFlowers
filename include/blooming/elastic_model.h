...
private:
	...
	public:
		...
		double computeTheta( Eigen::Vector3d& x0, Eigen::Vector3d& x1, Eigen::Vector3d& x2, Eigen::Vector3d& x3 );
...
/*		double   m_inv_sq_L;     // the invert of the square of the edge length*/
	...
	public:
		...
		unsigned int  m_facet_idx;  // 三角形的索引
	};
