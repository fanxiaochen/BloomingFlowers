...
namespace OSGUtility
{
  ...
  osg::Geode* drawCylinder(const osg::Vec3& base, const osg::Vec3& top, double thickness, const osg::Vec4& color);
	osg::Geode* drawCylinders(const osg::Vec3Array* bases, const osg::Vec3Array* tops, const std::vector<double>& radii, const osg::Vec4Array* colors, int subdivide_level=2);
  ...
  osg::Geode* drawCone(const osg::Vec3& base, const osg::Vec3& top, double radius, const osg::Vec4& color);
	...
	osg::Group* drawArrow(const osg::Vec3& base, const osg::Vec3& top, double radius, const osg::Vec4& color);
